 ...
 <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="left" valign="top"  style="background:url(../images/right_bg.gif) bottom repeat-x"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="43" style="background:url(../images/title.gif) left no-repeat" class="title_zi">止付查询</td>
      </tr>
    </table>
      <table width="75%" border="0" cellpadding="0" cellspacing="0" class="list" style="margin-left:33px;margin-top:34px">
        ...
        <tr>
          ...
          <td align="center">&nbsp;</td>
		        ...
		        <tr>
          <th>止付类型</th>
       <input type="hidden" name="column3" value="004">
	    <input name="operator3" type="hidden" value="equals" >
				<td bgcolor="#FFFFFF">	  
              <select name="value3">
                  <option value="">全部</option>
                  <option  value="0">单笔止付</option>
                  <option  value="1">整包止付</option>
                </select></td>
          <td align="center">&nbsp;</td>
        </tr>
		        <tr>
          <th>委托日期</th>
          <td align="left">
	      <input name="column4" type="hidden" value="002">
