...
<html>
    ...
    <body>
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td bgcolor="#3685CB" width="100">
                    <div align="center" class="tt"><font color="#FFFFFF">角色权限管理</font></div>
                </td>
                <td>&nbsp;</td>
                <td>
        ...
        <form name="form1" method="post" action="ModifyRolePermission.action">  
            ...
            <table width="80%"  border="0" align="center" cellspacing="1" bgcolor="#999999">
                ...
                <ww:iterator value="roles" status="status">
                    <tr bgcolor="#ffffff">
                        <td><div align="center">
                                <input type="checkbox" name="checkbox_modify" value="<ww:property value="module.id"/>" <ww:if test="checked == 'true' "> checked 
                                       </ww:if>>
                            </div></td>
