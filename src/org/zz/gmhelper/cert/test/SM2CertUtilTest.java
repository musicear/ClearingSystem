...
public class SM2CertUtilTest {
    private static final String ROOT_PRI_PATH = "D:/workspace/Tips_qhd/target/test.root.ca.pri";
    private static final String ROOT_CERT_PATH = "D:/workspace/Tips_qhd/target/test.root.ca.cer";
    private static final String MID_PRI_PATH = "D:/workspace/Tips_qhd/target/test.mid.ca.pri";
    private static final String MID_CERT_PATH = "D:/workspace/Tips_qhd/target/test.mid.ca.cer";
    private static final String USER_PRI_PATH = "D:/workspace/Tips_qhd/target/test.user.pri";
    private static final String USER_CERT_PATH = "D:/workspace/Tips_qhd/target/test.user.cer";
    ...
    public void testGetBCECPublicKey() {
        try {
            ...
            X509Certificate cert = SM2CertUtil.getX509Certificate("D:/workspace/Tips_qhd/target/test.sm2.cer");
            BCECPublicKey pubKey = SM2CertUtil.getBCECPublicKey(cert);
            byte[] priKeyData = FileUtil.readFile("D:/workspace/Tips_qhd/target/test.sm2.pri");
