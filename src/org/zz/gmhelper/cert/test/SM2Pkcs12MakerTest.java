...
public class SM2Pkcs12MakerTest {
    ...
    private static final String TEST_P12_FILENAME = "D:\\workspace\\Tips_qhd\\target\\test.p12";
    ...
    public void testMakePkcs12() {
        try {
            ...
            KeyStore pkcs12 = pkcs12Maker.makePkcs12(subKP.getPrivate(), cert, TEST_P12_PASSWD);
            	...
            	FileOutputStream  os = new FileOutputStream(TEST_P12_FILENAME);
    ...
    public void testPkcs12Sign() {
        ...
        try {
            ...
            InputStream is = new FileInputStream(TEST_P12_FILENAME);
