...
public class SM2UtilTest extends GMBaseTest {
    ...
    public void testKeyPairEncoding() {
        try {
            ...
            FileUtil.writeFile("D:\\workspace\\Tips_qhd\\target\\ec.pkcs8.pri.der", priKeyPkcs8Der);

            String priKeyPkcs8Pem = BCECUtil.convertECPrivateKeyPKCS8ToPEM(priKeyPkcs8Der);
            FileUtil.writeFile("D:\\workspace\\Tips_qhd\\target\\ec.pkcs8.pri.pem", priKeyPkcs8Pem.getBytes("UTF-8"));
            ...
            FileUtil.writeFile("D:\\workspace\\Tips_qhd\\target\\ec.pkcs1.pri", priKeyPkcs1Der);
            ...
            FileUtil.writeFile("D:\\workspace\\Tips_qhd\\target\\c.x509.pub.der", pubKeyX509Der);

            String pubKeyX509Pem = BCECUtil.convertECPublicKeyX509ToPEM(pubKeyX509Der);
            FileUtil.writeFile("D:\\workspace\\Tips_qhd\\target\\ec.x509.pub.pem", pubKeyX509Pem.getBytes("UTF-8"));
    ...
    public void testEncodeSM2CipherToDER() {
        try {
            ...
            FileUtil.writeFile("D:/workspace/Tips_qhd/target/derCipher.dat", derCipher);
    ...
    public void testEncodeSM2CipherToDER_C1C2C3() {
        try {
            ...
            FileUtil.writeFile("D:/workspace/Tips_qhd/target/derCipher_c1c2c3.dat", derCipher);
