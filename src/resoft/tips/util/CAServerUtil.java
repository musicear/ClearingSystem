...
public class CAServerUtil
{

    private static Log _logger =  LogFactory.getLog(CAServerUtil.class);;
    private static String DN = null;
    private DSign dSign;

    static {
    	   	Configuration conf = Configuration.getInstance();
         	String strPropFile=conf.getProperty("general", "keyPath");
         	String _DN=conf.getProperty("general", "DN");
         	CAServerUtil.init(strPropFile,  _DN);
	}
