...
public class AnaFile implements Action {
	 private static final Log logger = LogFactory.getLog(AnaFile.class);
	 ...
	 static {
		...
		public int execute(Message arg0) throws Exception {
				...
				SaveDB2201 save2201 = new SaveDB2201();
				//SaveDB2202 save = new SaveDB2202();
				for (String name : ziplist){
					
					File f=new File(saveFile + name);
					logger.info("filedir is :" + saveFile);
					logger.info("filename is :" + name);
			        ...
			        transNo = name.substring(18, 19);
			        if(transNo.equals("A"))
			        	save2201.testMessage(msg);
				}
		...
		class PackReader extends DefaultHandler {
	        ...
	        private boolean isBill2202 = false;
	        private boolean isBill2201 = false;
	        private int Count_Bill2202 = 0;
	        private int Count_Bill2201 = 0;
	        private int Count_Detail2202 = 0;
	        private int Count_Detail2201 = 0;
	        private Message msg;
