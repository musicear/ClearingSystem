 ...
 * Date: 2008-8-20 
 */
public class SaveDB5102 extends AbstractSyncAction {
    private static final Log logger = LogFactory.getLog(SaveDB5102.class);
        ...
        for (int event = reader.next(); event != XMLStreamConstants.END_DOCUMENT; event = reader.next()) {
            switch (event) {
                case XMLStreamConstants.START_ELEMENT:
                    ...
                    if (localName.equals("BatchHead5102")) {
                    	packParams.clear();
                    	billCount=0;
                    } else if (localName.equals("Bill5102")) {
                    	quotaParams.clear();
                    	billCount ++;
                    	detailCount=0;
                    } else if (localName.equals("Detail5102")) {
                    	detailParams.clear();
                    	detailCount ++;
                    }
                    if (tagStack.size() > 1) {
                ...
                case XMLStreamConstants.CHARACTERS:
                    ...
                    if (!text.equals("")) {
                    	if (parentLocalName.equals("BatchHead5102")) {
                    	...
                    	} else if (parentLocalName.equals("Bill5102")) {
                    	...
                    	} else if (parentLocalName.equals("Detail5102")) {
                ...
                case XMLStreamConstants.END_ELEMENT:
                    localName = reader.getLocalName();
                    tagStack.pop();
                    if (localName.equals("Detail5102")) {
                    ...
                    } else if (localName.equals("BatchHead5102")) {
                    	packParams.put("payType", "1");
                    	packParams.put("checkStatus", "0");
                    	packParams.put("procFlag", "0");
                    	quotaParams.put("payType", "1");
...
//                    	全部明细处理完毕，设置批量包处理状态为“接收完毕”
                        ...
                        " where TreCode='" + treCode + "' and entrustDate='" + entrustDate + "' and packNo='" + packNo + "' and payType='1'";
